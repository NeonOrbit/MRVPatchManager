...
object Utils {
    fun log(msg: String) = Log.d(AppConfigs.APP_TAG, msg)
    fun warn(msg: String) = Log.w(AppConfigs.APP_TAG, msg)
    fun error(msg: String) = Log.e(AppConfigs.APP_TAG, msg)
    fun warn(msg: String, t: Throwable) = Log.w(AppConfigs.APP_TAG, msg, t)
    fun error(msg: String, t: Throwable) = Log.e(AppConfigs.APP_TAG, msg, t)
    ...
    fun absoluteUrl(host: String, url: String) = when {
